...
from hbaselines.algorithms import OffPolicyRLAlgorithm_COM
from hbaselines.goal_conditioned_com_2.td3 import GoalConditionedPolicy

EXAMPLE_USAGE = 'python run_comhrl.py "HalfCheetah-v2" --meta_period 10'
...
def main(args, base_dir):
    ...
    for i in range(args.n_training):
        ...
        params_with_extra['policy_name'] = "GoalConditionedPolicy_COM"
